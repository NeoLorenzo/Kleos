-- Kleos #26 is an ingestion/storage/UI feature. Preserve the existing Kleos Bot
-- methodology 1.0.0 evidence contract rather than silently adding a new input group.
