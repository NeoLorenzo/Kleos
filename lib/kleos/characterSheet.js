...
export function buildCharacterEvidence(kleosData = {}) {
  ...
  return {
    ...
    psychological: compact([
      hasMisc ? "General profile evidence recorded" : "No dedicated psychological profile evidence recorded"
    ]),
    ...
    financial: compact([
      hasMisc ? "Financial/profile evidence available in canonical miscellaneous records" : "No dedicated financial evidence recorded"
    ]),
    relational: compact([
      hasMisc ? "Relationship/profile evidence available in canonical miscellaneous records" : "No dedicated relational evidence recorded"
    ]),
    creative: compact([
      hasCv ? "Writing/project output represented in CV record" : "No CV output record available",
      hasMisc ? "Additional profile evidence recorded" : null
    ]),
    experiential: compact([
      hasCv ? "Education/work/lived-environment evidence represented in CV record" : "No CV experience record available",
      hasMisc ? "Additional lived-experience profile evidence recorded" : null
    ])
  };
}
