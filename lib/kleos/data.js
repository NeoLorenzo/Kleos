...
export async function loadKleosData(userId) {
  ...
  const [
    ...
    supabase
      ...
      .select("source_exercise_id,exercise_name,equipment_name,best_1rm,qualifying_sessions,achieved_on,estimation_basis,is_current,synced_at,last_checked_at,source")
      .eq("user_id", userId)
